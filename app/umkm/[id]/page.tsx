      ...
      <main className="min-h-screen bg-linen dark:bg-[#121212]">
        ...
        <section className="mx-auto max-w-6xl px-4 pb-16 pt-6 md:px-8 md:pt-10">
          <div className="grid gap-8 md:grid-cols-2 md:gap-12">
            {/* Gambar */}
            <div className="relative aspect-[4/3] overflow-hidden rounded-2xl bg-fog dark:bg-[#2a2a2a]">
              {umkm.gambar ? (
                <Image
                  src={umkm.gambar}
                  alt={umkm.namaProduk}
            ...
            <div className="flex flex-col justify-center">
              {/* Kategori Badge */}
              <span className="mb-3 inline-flex w-fit rounded-full bg-paper px-3.5 py-1.5 text-[12px] font-semibold text-obsidian shadow-xs ring-1 ring-sage dark:bg-[#1a1a1a] dark:text-white dark:ring-[#414943]">
                {umkm.kategori}
              </span>
              ...
              {/* Pemilik */}
              <div className="mt-5 flex items-center gap-2 text-body-large text-iron dark:text-white/60">
              ...
              <div className="mt-5">
                ...
                <p className="text-body-base leading-relaxed text-iron dark:text-white/70">
                  {umkm.deskripsi}
                </p>
              </div>
              ...
              <div className="mt-6">
                ...
                <div className="flex items-center gap-2 text-body-base text-iron dark:text-white/70">
                ...
                <a
                  ...
                  className="mt-3 inline-flex items-center gap-2 rounded-xl bg-[#25D366] px-5 py-2.5 text-[13px] font-semibold text-white transition hover:bg-[#1da854]"
                >
